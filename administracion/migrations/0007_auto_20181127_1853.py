# Generated by Django 2.1.3 on 2018-11-27 18:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('administracion', '0006_auto_20181125_0121'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='venta',
            name='monto',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='MXN', max_digits=14),
        ),
        migrations.AddField(
            model_name='venta',
            name='monto_currency',
        ...
        migrations.AddField(
            model_name='venta',
            name='pedido',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='administracion.Pedido'),

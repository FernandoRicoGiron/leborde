	...
	$.each( json, function( key, value ) {
		...
		if (tipo == "char") {
			...
			file = '<div class="col-md-12">'+
						'<div class="form-group">'+
						  '<label class="bmd-label-floating">'+label+'</label>'+
			              '<span class="btn btn-info btn-file" ><input disabled style="z-index: 10000;" type="file" id="files2" name="'+name+'" accept="image/jpeg, image/png"/><p style="z-index: -10000; margin-bottom:0">Seleccione la imagen que representa a la colección</p></span></a>'+
			            '</div>'+
